...
const long utcOffsetInSeconds = 25200;   // IST offset (UTC + 7:30)
...
// History of valid number plates and their entry timesN
struct PlateEntry {
...
http.begin(serverResponse.c_str()); 
    ...
    String jsonData = "{\"plateNumber\":\"" + newEntry.plateNumber + "\",\"time\":\"" + newEntry.time + "\"}";
