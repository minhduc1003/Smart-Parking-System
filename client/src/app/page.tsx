...
export default function Home() {
  return (
    ...
    <main className="p-6 sm:p-8 md:p-12 ">
      ...
      >
      <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-emerald-600 tracking-tight">Entrance Camera</h2>
      ...
      <div>
      <h3 className="font-semibold text-emerald-500 text-lg">License Plate:</h3>
      <div className="bg-emerald-50/80 backdrop-blur-sm p-3 sm:p-4 rounded-xl mt-2 shadow-inner">
      <p id="entrance-plate" className="font-mono text-base sm:text-lg text-emerald-700">
      ...
      Time In: <span className="font-bold">{new Date().toLocaleTimeString()}</span>
      </p>
      </div>
      </motion.div>
      ...
      className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 sm:p-8 border border-emerald-100 hover:border-emerald-200"
      >
      <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-emerald-600 tracking-tight">Exit Camera</h2>
      <div className="relative w-[480px] h-[320px] mx-auto overflow-hidden rounded-xl shadow-lg">
      <iframe
      ...
      <p className="text-sm sm:text-base text-emerald-600 font-medium">
      Time Out: <span className="font-bold">{new Date().toLocaleTimeString()}</span>
      </p>
      </div>
      </motion.div>
      </div>
